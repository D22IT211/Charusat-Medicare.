...
?>
    ...
    <form method="post">
    <a href="index.html" class="btn"> Home <span class="fas fa-chevron-right"></span> </a><br>
    <a href="cont_us.html" class="btn">  Submit another feedback  <span class="fas fa-chevron-left"></span> </a>
    </form>
    <style>
        *{
            text-align: center;
